# Service Growth Model - SteadyTap
...
| Field | Decision |
|---|---|
| Service type | Mobile accessibility and habit coaching |
| Primary reader or buyer | Accessibility, coaching, or mobile habit users if retention is proven. |
| Wedge | TestFlight validation and accessibility review. |
