...
- Review 1 redacted secret-pattern finding(s) from the audit index before publishing or deploying.
...
- Redacted audit has 1 possible secret-pattern finding(s); manually review before publication or deploy.
