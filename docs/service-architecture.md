# Service Architecture - SteadyTap
...
- **Lane:** Mobile accessibility and habit coaching
- **Primary buyer:** Accessibility, coaching, or mobile habit users if retention is proven
- **First motion:** TestFlight validation and accessibility review

## Recommended Architecture

iOS/TestFlight first, optional backend on Supabase or small FastAPI service, Cloudflare Pages for public proof.
...
- **Monetization route:** Accessibility coaching app with subscription, organization pilot, or app-store path.
