...
| Primary buyer or user | Accessibility-focused users, care teams, educators, and mobile product teams. |
| Value wedge | Offline-first iOS coaching with optional sync and caregiver/team reporting. |
...
| First action | Open the portfolio-fit note, confirm the successor project, then inspect Swift build passes only if this domain is relevant. |
...
- Use Weekly active routines only as a discussion metric until fresh validation exists.
